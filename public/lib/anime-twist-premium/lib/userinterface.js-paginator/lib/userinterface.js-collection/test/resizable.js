...
const scriptsFile = [
	...
	fs.readFileSync(path.resolve(__dirname, "../userinterface/resizable.js"), { encoding: "utf-8" }),
...
exports.model = async function (test) {
	...
	const expected = '<div class="resizable"></div><div class="resizable-preview"></div>'
	await window.UserInterface.runModel("collection.resizable", { parentNode: window.document.body, bindingArgs: [{}, []] })
